...
@RequestMapping("/internal/client-groups/{clientGroupId}/open-banking-legacy-certificates")
@Api(tags = "certificates")
public class OBLegacyController {
    private final ClientGroupIdVerificationService clientGroupIdVerificationService;
    private final OBLegacyService obLegacyService;
    ...
    public CertificateDTO createCertificateSigningRequest(
            ...
            @Valid @RequestBody OBLegacyCertificateSigningRequestDTO inputDTO,
        ...
        return obLegacyService.createCertificateSigningRequest(clientGroupToken, inputDTO);
    }
    ...
    public List<CertificateDTO> getAllCertificates(
        ...
        clientGroupIdVerificationService.verify(clientGroupToken, clientGroupId);
        return obLegacyService.getCertificates(clientGroupToken);
    }
    ...
    public CertificateDTO getCertificate(
        ...
        clientGroupIdVerificationService.verify(clientGroupToken, clientGroupId);
        return obLegacyService.getCertificate(clientGroupToken, certificateId);
    }
    ...
    public CertificateDTO updateCertificateName(
        ...
        clientGroupIdVerificationService.verify(clientGroupToken, clientGroupId);
        return obLegacyService.updateName(clientGroupToken, certificateId, inputDTO);
    }
    ...
    public ValidatedCertificateChainDTO validateCertificateChain(
        ...
        return obLegacyService.verifyCertificateChain(clientGroupToken, certificateId, certificates);
    }
    ...
    public List<CertificateInfoDTO> updateCertificateChain(
        ...
        String certificate = new String(Base64.decode(inputDTO.getCertificateChain()));
        List<X509Certificate> certificates = KeyUtil.parseCertificateChain(certificate);
        return obLegacyService.updateCertificateChain(clientGroupToken, certificateId, certificates);
    }
}
