...
class OBLegacyServiceTest {
    private static final CertificateType CERTIFICATE_TYPE = CertificateType.OB_LEGACY;
    @Mock
    ...
    void createCertificateSigningRequest() {
        ...
        CertificateDTO result = obLegacyService.createCertificateSigningRequest(clientGroupToken, certificateSigningRequestDTO);
    ...
    void getCertificates() {
        ...
        List<CertificateDTO> result = obLegacyService.getCertificates(clientGroupToken);
    ...
    void getCertificate() {
        ...
        CertificateDTO result = obLegacyService.getCertificate(clientGroupToken, certificateId);
    ...
    void updateName() {
        ...
        CertificateDTO result = obLegacyService.updateName(clientGroupToken, certificateId, newCertificateNameDTO);
    ...
    void verifyCertificateChain() throws Exception {
        ...
        ValidatedCertificateChainDTO result = obLegacyService.verifyCertificateChain(clientGroupToken, certificateId, certificateChain);
        assertThat(result.isValid()).isTrue();
        assertThat(result.getMessage()).isNull();
        assertThat(result.getInfo()).isSameAs(certificateInfoDTO);

        verify(validationService).validateLegacyCertificateChain(certificateChain);
    }
    ...
    void verifyCertificateChain_invalid_chain() throws Exception {
        ...
        doThrow(new CertificateValidationException("oops")).when(validationService).validateLegacyCertificateChain(certificateChain);
    ...
    void updateCertificateChain() throws Exception {
        ...
        List<CertificateInfoDTO> result = obLegacyService.updateCertificateChain(clientGroupToken, certificateId, certificateChain);
